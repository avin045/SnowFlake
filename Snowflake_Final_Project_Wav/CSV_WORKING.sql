-- CREATE SCHEMA
create schema AVINASH_SCHEMA;

-- CREATE TABLE TO LOAD CSV DATA 

CREATE OR REPLACE TABLE PRACTICEDB.AVINASH_SCHEMA.HEALTHCARE_CSV( 
...
CREATE OR REPLACE FILE FORMAT PRACTICEDB.AVINASH_SCHEMA.HEALTHCARE_CSV_FORMAT 
TYPE = 'CSV' 
FIELD_DELIMITER = '|' 
SKIP_HEADER = 1; 
 
-- CREATE STAGE OBJECT TO LET SNOWFLAKE KNOW FROM WHERE TO PICK THE FILES 
CREATE OR REPLACE STAGE PRACTICEDB.AVINASH_SCHEMA.HEALTHCARE_CSV_STAGE 
...
SELECT $1, $5 , $2
FROM @PRACTICEDB.AVINASH_SCHEMA.HEALTHCARE_CSV_STAGE;

-- USE COPY COMMAND TO INGEST DATA FROM AZURE 
COPY INTO PRACTICEDB.AVINASH_SCHEMA.HEALTHCARE_CSV 
FROM @PRACTICEDB.AVINASH_SCHEMA.HEALTHCARE_CSV_STAGE;
...
FROM PRACTICEDB.AVINASH_SCHEMA.HEALTHCARE_CSV
WHERE $1 < 30000;