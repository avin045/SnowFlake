-- Lesson_11_The_Share_and_the_Shareback!
...
desc table MAX_OUTGOING.FOR_ACME.LOTSTOCKRETURN;

show tables;

select count(*) from max_outgoing.for_acme.lotstockenhanced;
select * from max_outgoing.for_acme.lotstockreturn;