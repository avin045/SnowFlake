...
GRANT USAGE ON DATABASE DEMO_DB_SDS TO SHARE DEMO_SHARE;
GRANT USAGE ON SCHEMA DEMO_DB_SDS.DEMO_SCHEMA TO SHARE DEMO_SHARE;
GRANT SELECT ON TABLE DEMO_DB_SDS.DEMO_SCHEMA.DEMO_TABLE TO SHARE DEMO_SHARE;

-- Create a reader account
CREATE MANAGED ACCOUNT SNOWFLAKE_TUTORIAL_READER_ACCOUNT 
admin_name='reader_account', 
admin_password='Passw0rd', 
type=reader;
/*OUTPUT :
{"accountName":"TU28784","loginUrl":"https://tu28784.ap-southeast-1.snowflakecomputing.com"}
*/

SHOW MANAGED ACCOUNTS; -- to copy url

-- Add reader account to share
ALTER SHARE DEMO_SHARE ADD ACCOUNTS = tu28784;-- <reader_account_locator>

-- EXECUTE FROM WITHIN READER ACCOUNT
USE ROLE ACCOUNTADMIN;

-- Create a database in the reader account from a share
CREATE DATABASE DEMO_DB_SDS_READER FROM SHARE <main_account_locator>.DEMO_SHARE; -- e.g ek83803

GRANT IMPORTED PRIVILEGES ON DATABASE DEMO_DB_SDS_READER TO ROLE SYSADMIN;
